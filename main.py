...
if __name__ == '__main__':
    ...
    parser.add_argument('--reason', type=str, help='入校原因, eg. 吃饭', default='科研')
    parser.add_argument('--reason1', type=str, help='出校原因, eg. 吃饭', default='回家')
    parser.add_argument('--destination', type=str, help='出校目的地, eg. 北京', default='北京')
    parser.add_argument('--track', type=str, help='出校轨迹, eg. 畅春园食堂', default='电驴or四号线转二号线')
    ...
    parser.add_argument('--street', type=str, help='入校前居住所在街道, eg. 燕园街道', default='德胜街道')
